...
@router.get(ENDPOINTS.MILESTONES.GET_LIST, response_model=list[MilestoneDataResponse])
...
@router.get(ENDPOINTS.MILESTONES.DETAIL, response_model=MilestoneDataResponse)
...
@router.patch(ENDPOINTS.MILESTONES.DETAIL, response_model=MilestoneDataResponse)
