...
CREATE_CONVERSATION_SYSTEM_INSTRUCTION: dict[str, str] = {
    "shadow": (
        ...
        " Use the appropriate tool whenever the user's request requires current application data"
        " that is not reliably available from the user's message alone."
        " Do not guess or fabricate application data."
        "\n\n"
        "When a tool can provide information you need, call the tool directly."
...
RESPOND_TO_MESSAGE_SYSTEM_INSTRUCTION: dict[str, str] = {
    "shadow": (
        ...
        "You have access to tools that provide current information from the application."
        " Use the appropriate tool whenever the user's request requires current application data"
        " that is not reliably available in the conversation context."
        " Do not guess or fabricate application data."
        "\n\n"
        "When a tool can provide the information you need, call the tool directly."
        " Do not tell the user that you are going to call a tool."
        " Do not simulate a tool call in your response."
        " Do not respond with phrases such as 'Let me check', 'I'll fetch that',"
        " or 'One moment' when a tool is required."
        ...
        " Never write lists as plain inline text separated by commas or numbers in a single sentence."
        "\n\n"
        "Return only the final user-facing response as plain text with Markdown formatting."
