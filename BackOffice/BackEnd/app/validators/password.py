...
def validate_password(value: str) -> str:
    """Basic length check — used for login (never enforces complexity)."""
    if not value:
...
def validate_password_strong(value: str) -> str:
    """Full complexity checks — for minting a new admin account, which is at
    least as sensitive as a regular Shadow V2 user registering."""
