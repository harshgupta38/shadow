...
export function Pagination({
  ...
  // to navigate between, so they'd just be dead controls sitting there.
  const canPage = totalItems > pageSize;
          ...
          <>
            ...
            {showEllipsis && (
              <>
                ...
                <button type="button" className="page-number-btn" onClick={() => onPageChange(totalPages)}>
                  {totalPages}
                </button>
              </>
            )}
