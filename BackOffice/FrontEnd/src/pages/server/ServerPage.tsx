    ...
    <>
                      ...
                      <tr className="dp-confirm-row">
                        <td colSpan={8}>
                          <div className="dp-confirm-inner">
                            ...
                            <button className="btn-action btn-action--danger" onClick={() => runRestart(w)}>
                              Yes, restart
                            </button>
                            <button className="btn-action btn-action--ghost" onClick={() => setConfirmWorkerId(null)}>
                              Cancel
                            </button>
                          </div>
                        </td>
      ...
      <Modal show={showRestartModal} onHide={() => setShowRestartModal(false)} centered className="deploy-modal">
        <Modal.Header>
          ...
          <button className="btn btn-ghost btn-icon" onClick={() => setShowRestartModal(false)} aria-label="Close">
            <XLg size={14} />
          </button>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <button className="btn btn-ghost" onClick={() => setShowRestartModal(false)}>
            Cancel
          </button>
          <button className="btn btn-danger d-flex align-items-center gap-2" onClick={() => runRestart("all")}>
