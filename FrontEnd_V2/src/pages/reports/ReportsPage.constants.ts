...
import type { DayData, Stats, ScoreTier } from "@/pages/reports/types";
export type { ScoreTier, DayData, CalDay, CalFiller, CalCell, Stats } from "@/pages/reports/types";

export const TODAY = todayDate();

export const DAY_LABELS = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];

export const RING_CIRC = 2 * Math.PI * 16;
  ...
  for (let d = 1; d <= totalDays; d++) {
    ...
    out.set(key, src
      ? {
        ...
        hasReport: src.has_report,
      }
      : { score: null, habitsTotal: 0, habitsDone: 0, tasksTotal: 0, tasksDone: 0, scheduleTotal: 0, scheduleDone: 0, hasReport: false },
    );
  }
  return out;
}
