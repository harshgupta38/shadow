      ...
      {loading ? (
            ...
            <div className="rp-stats">
              {([58, 44, 66, 50] as const).map((w, i) => (
                <div key={i} className="rp-stat">
                  <span className="rp-stat-val rp-ghost-pill" />
                  <span className="rp-stat-name rp-ghost-pill" style={{ width: `${w}%` }} />
                  <span className="rp-stat-hint rp-ghost-pill" style={{ width: `${w - 14}%` }} />
                </div>
              ))}
            </div>
            <div className="surface rp-cal-shell mt-3">
              <div className="rp-cal-panel-head">
                <span className="rp-ghost-pill" style={{ width: 110, height: 13, margin: "0 auto" }} />
              </div>
              ...
              <div className="rp-cal-grid">
                {Array.from({ length: 35 }, (_, i) => (
                  <div key={i} className="rp-filler rp-ghost-cell" />
                ))}
              </div>
            </div>
          </div>
          <div className="rp-ghost-core">
            <div className="rp-ghost-icon"><span className="rp-loading-spinner" /></div>
        ...
        <>
          ...
          <div className="surface rp-cal-shell mt-3">
            ...
            {fetchError && <div className="rp-cal-error">{fetchError}</div>}
                      ...
                      <div className="rp-day-ring" aria-hidden="true">
                        <svg viewBox="0 0 40 40" className="rp-day-ring-svg">
                          <g transform="rotate(-90 20 20)">
                            ...
                            <circle className="rp-day-ring-fill" cx="20" cy="20" r="16"
